...
<body id="page-top"  onLoad="renderTime(); renderDate();">     
    ...
    <div class="modal fade" id="editviewCOL_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <form action="viewReports_CRUD.php" method="POST">
                    ...
                    <div class="modal-footer">
                       <button type='button' class='btn btn-danger mr-auto deleteCOL'>Delete</button></td>
                        ...
                        <button type="submit" name="viewCOL" class="btn btn-primary">Update</button>
                    </div>
                </form>
     ...
     <div class="modal fade" id="deleteviewCOL_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-top-centered" role="document">
            <div class="modal-content">
                ...
                <form action="viewReports_CRUD.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                        <button type="submit" name="deleteCOL" class="btn  btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="violation-college.php">College & TED</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
        ...
        <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">This is for College & TED Department, if you wish to add report(s) <a
                            href="reports.php">click here</a>.</p>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Date: <em style="color: #858796">Pending</em> Time: <em style="color: #858796">Pending</em></h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-bordered"  width="100%" cellspacing="0">
                                    ...
                                    $sql = "SELECT * FROM prefect_reports WHERE dept_code = 'college'";
                                    $query = $con->query($sql);
                                    ...
                                    echo "
                                        ...
                                        <td><button type='button' class='btn-circle btn-danger deleteCOL'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill' viewBox='0 0 16 16'>
...
<script>
    $(document).ready(function () 
    {
        ...
        {
            $('#deleteviewCOL_modal').modal('show');
            $tr = $(this).closest('tr');
