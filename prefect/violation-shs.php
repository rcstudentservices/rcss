...
<body id="page-top" onLoad="renderTime(); renderDate();">   
    ...
    <div class="modal fade" id="editviewSHS_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <form action="viewReports_CRUD.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="viewSHS" class="btn btn-primary">Update</button>
                    </div>
                </form>
    ...
    <div class="modal fade" id="deleteviewSHS_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-top-centered" role="document">
            <div class="modal-content">
                ...
                <form action="viewReports_CRUD.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                        <button type="submit" name="deleteSHS" class="btn  btn-danger">Delete</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="violation-shs.php">Senior High School</a>
        ...
        <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">This is for Senior High School Department, if you wish to add report(s) <a target="_blank"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-bordered"  width="100%" cellspacing="0">
                                    ...
                                    $sql = "SELECT * FROM prefect_reports WHERE dept_code = 'shs'";
                                    $query = $con->query($sql);
...
<script>
    ...
    {
        $('.deleteSHS').on('click', function () 
        {
            $('#deleteviewSHS_modal').modal('show');
            $tr = $(this).closest('tr');
...
<script>
    $(document).ready(function () 
    {
    $('.viewSHS').on('click', function () 
    {
        $('#editviewSHS_modal').modal('show');
        $tr = $(this).closest('tr');
