...
else if (isset($_SESSION['hloggedin'])) {
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="view-violation-college.php">College & TED</a>
        ...
        <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            ...
                            <span>Clinic Office Records</span>
                        </div>
                    </form>
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">The data are from student handbook, if you wish to <a
                            ...
                            href="violation-college.php">view reports</a>.</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="miCOL" class="table table-bordered display"  width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th hidden>id</th>
                                    ...
                                    $sql = "SELECT * FROM tbl_violation WHERE vio_dept = 'COLLEGE' AND vio_desc != 'n/a' AND vio_name = 'MINOR OFFENSES'";
                                    $query = $con->query($sql);
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="damiCOL" class="table table-bordered display"  width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th hidden>id</th>
                                    ...
                                    $sql = "SELECT * FROM tbl_violation WHERE vio_dept = 'COLLEGE' AND vio_offense != 'n/a' AND vio_desc != 'n/a' AND vio_name = 'DISCIPLINARY ACTIONS FOR MINOR OFFENSES' ORDER BY vio_offense ASC";
                                    $query = $con->query($sql);
                                    while($row = $query->fetch_assoc()){
                                    echo "
                                        <tr>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="maCOL" class="table table-bordered display"  width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th hidden>id</th>
                                            <th>Category</th>
                                    ...
                                    $sql = "SELECT * FROM tbl_violation WHERE vio_dept = 'COLLEGE' AND vio_cat != 'n/a' AND vio_desc != 'n/a' AND vio_name = 'MAJOR OFFENSES' ORDER BY vio_cat ASC";
                                    $query = $con->query($sql);
                                    while($row = $query->fetch_assoc()){
                                    echo "
                                        <tr>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class=" font-weight-bold text-primary">Disciplinary Actions for Major Offenses</h6>

                            <button type="button" class="btn-circle btn-primary" data-toggle="modal" data-target="#adddamiJHS_modal" style="float: right; font-size: 13px; padding: 6px; margin-top: -30px"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16"><path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.5 4.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3a.5.5 0 0 1 1 0z"/></svg></button>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="damaCOL" class="table table-bordered display"  width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th hidden>id</th>
                                            <th>No. of Occurence</th>
                                    ...
                                    $sql = "SELECT * FROM tbl_violation WHERE vio_dept = 'COLLEGE' AND vio_offense != 'n/a' AND vio_desc != 'n/a' AND vio_name = 'DISCIPLINARY ACTIONS FOR MAJOR OFFENSES' ORDER BY vio_offense ASC";
                                    $query = $con->query($sql);
                                    while($row = $query->fetch_assoc()){
                                    echo "
                                        <tr>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="miadCOL" class="table table-bordered display"  width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th hidden>id</th>
                                            <th>Minor Offenses</th>
                                    ...
                                    $sql = "SELECT * FROM tbl_violation WHERE vio_dept = 'COLLEGE' AND vio_desc != 'n/a' AND vio_name = 'ADDENDUM TO THE LIST OF MINOR OFFENSES'";
                                    $query = $con->query($sql);
                                    while($row = $query->fetch_assoc()){
                                    echo "
                                        <tr>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class=" font-weight-bold text-primary">Disciplinary Actions for Addendum Minor Offenses</h6>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="damaadSHS" class="table table-bordered display"  width="100%" cellspacing="0">
                                    ...
                                    $sql = "SELECT * FROM tbl_violation WHERE vio_dept = 'COLLEGE' AND vio_offense != 'n/a' AND vio_desc != 'n/a' AND vio_name = 'DISCIPLINARY ACTIONS FOR ADDENDUM MINOR OFFENSES' ORDER BY vio_offense ASC";
                                    $query = $con->query($sql);
                                    while($row = $query->fetch_assoc()){
                                    echo "
                                        <tr>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="damaadSHS" class="table table-bordered display"  width="100%" cellspacing="0">
                                    ...
                                    $sql = "SELECT * FROM tbl_violation WHERE vio_dept = 'COLLEGE' AND vio_cat != 'n/a' AND vio_desc != 'n/a' AND vio_da != 'n/a' AND vio_conduct != 'n/a' AND vio_name = 'ADDENDUM TO THE LIST OF MAJOR OFFENSES AND DISCIPLINARY ACTIONS' ORDER BY vio_cat ASC";
                                    $query = $con->query($sql);
                                    while($row = $query->fetch_assoc()){
                                    echo "
                                        <tr>
