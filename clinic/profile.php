							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<input type="hidden" name="emp_idnum" value="<?php echo $emp_idnum?>">
										<label>First Name</label>
										<input type="text" name="emp_fname" class="form-control" value="<?php echo $emp_fname?>" placeholder="Enter First Name" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Middle Name</label>
										<input type="text" name="emp_mname" class="form-control" value="<?php echo $emp_mname?>" placeholder="Enter Middle Name" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Last Name</label>
										<input type="text" name="emp_lname" class="form-control" value="<?php echo $emp_lname?>" placeholder="Enter Last Name" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Job Position</label>
										<input type="text" name="job_code" class="form-control" value="<?php echo $job_code?>" placeholder="Enter Job Position" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Email</label>
										<input type="text" name="emp_email" class="form-control" value="<?php echo $emp_email?>" placeholder="Enter Email" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Phone number</label>
										<input type="text" name="emp_contactnum" class="form-control" value="<?php echo $emp_contactnum?>" placeholder="Enter Phone Number" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Address</label>
										<input type="text" name="emp_address" class="form-control" value="<?php echo $emp_address?>"placeholder="Enter Address" required>
									</div>
								</div>
							</div>
							<div>
