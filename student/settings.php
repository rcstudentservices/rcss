<?php      
  ...
  {   
    ...
    $val = $con->prepare('SELECT stud_idnum, stud_lname, stud_fname, stud_mname, stud_address, stud_contactnum, stud_email, stud_birthdate, section_code, yearlevel_code, course_code, dept_code, stud_guardianlname, stud_guardianfname, stud_guardianmname, stud_guardianrelationship, stud_guardiancontact, stud_guardianaddress FROM tbl_student WHERE id = ?');

    $val->bind_param('i', $_SESSION['sid']);
    $val->execute();
    $val->bind_result($stud_idnum, $stud_lname, $stud_fname, $stud_mname, $stud_address, $stud_contactnum, $stud_email, $stud_birthdate, $section_code, $yearlevel_code, $course_code, $dept_code, $stud_guardianlname, $stud_guardianfname, $stud_guardianmname, $stud_guardianrelationship, $stud_guardiancontact, $stud_guardianaddress);
    $val->fetch();
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $stud_fname . " " .$stud_lname?></span>
