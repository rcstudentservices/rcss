...
if (!isset($_SESSION['a_loggedin'])){   
    ...
    $stmt = $con->prepare('SELECT username, firstname, midname, lastname, address, contact_num, email FROM admin WHERE id = ?');
    // In this case we can use the account ID to get the account info.
    $stmt->bind_param('i', $_SESSION['a_id']);
    $stmt->execute();
    $stmt->bind_result($admin_username, $admin_fname, $admin_midname, $admin_lname, $admin_address, $admin_contnum, $admin_email);
    $stmt->fetch();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $admin_fname . " " .$admin_midname. " " . $admin_lname?></span>
            ...
            <div class="container-fluid">
             <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">New Employee Account</h1>

            <!-- Dropdown Card Example -->
        <div class="card shadow ">
            
                <div class="card-body">
                    <form method="post" action="save_new_employee.php">
                        <div class="row">
                          <div class="col-md-4">
                                <div class="form-group">
                                    <label>Employee Number</label>
							<input type="text"  class="form-control" name="emp_num" placeholder="Enter Employee Number" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Job Position</label>
						<input type="text"  class="form-control" name="job_code" placeholder="Enter Job Position" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Office</label>
						<select name="emp_office"  class="form-control" required>
							<option value="" disabled selected value >-- Select Office --</option>
							<option value="Office for Student Discipline">Office for Student Discipline</option>
							<option value="Office for Health Services">Office for Health Services</option>
						...
						<input type="text"  class="form-control" name="emp_mname" placeholder="Enter Employee's Middle Name" >
                                </div>
                            </div>
						...
						<input type="text"  class="form-control" name="emp_lname" placeholder="Enter Employee's Last Name" value="" required >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Address</label>
						 <textarea class="form-control" name="emp_address" placeholder="Enter Employee's Address Here..." required></textarea>
                                </div>
                            </div>
						...
						<input type="tel" name="emp_contactnum" required minlength="11" maxlength="13" placeholder="Enter Employee's Mobile Number" class="form-control wow fadeInUp" oninput="this.value = this.value.replace(/[^0-9+()]/g, '');" pattern="^(09|\+639)\d{9}$" title="09XXXXXXXXX OR +63XXXXXXXXXX">
                                </div>
                            </div>
						...
						<input type="email" name="emp_email"  class="form-control" placeholder="Enter Employee's Email Address">
                                </div>
                            </div>
                            ...
                            <div>
                                    <!-- button submit -->
                                   <center><button type="submit" class="col-md-6 btn btn-primary" name="submitJHS"  id="form_submit">Submit</button></center> 
                                </div>
